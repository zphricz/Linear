...
int main() {
  ...
  Matrix<double, 3> m_determine = {
      {0.0, 0.1, 0.2}, {4.0, -3.2, 0.0}, {2.1, 2.1, 9.4}};
  ...
  Matrix<double, 3> m_solve = {
      {8.0, 2.0, -4.0}, {3.0, 8.0, 6.0}, {2.0, 9.0, 4.5}};
  ...
  cout << "TESTING 3D VECTOR OPERATIONS" << endl << endl;
  {
    ...
    cout << "TIME TAKEN TO DO " << NUM_ROTATIONS << " MANY VECTOR ROTATIONS: "
